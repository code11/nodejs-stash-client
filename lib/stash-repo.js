...
Repo.prototype.getBranches = function () {
    return sUtils.makeRequest('/rest/api/1.0/projects/' + this.key + '/repos/' + this.slug + "/branches", this.settings);
};

Repo.prototype.getCommits = function () {
    return sUtils.makeRequest('/rest/api/1.0/projects/' + this.key + '/repos/' + this.slug + "/commits", this.settings);
};
